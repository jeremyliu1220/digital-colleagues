...
| Upgrade, backup, restore, and release rollback | Yes | P8 contract fixed; implementation not yet gated | Local SQLite online backup, validated atomic restore, matching-code rollback; no down-migration or availability claim |
