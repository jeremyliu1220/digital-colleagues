...
SQLite adapter. Policy `p3-boundary-specific-determinism-allowlist-v5` resolves import,
...
object dunder access is not allowed. Architecture fixtures must make unknown imports, reverse dependencies,
