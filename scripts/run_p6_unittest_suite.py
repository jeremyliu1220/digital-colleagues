...
P6_BOUNDARIES = {
    ...
    "tests.p6.test_authentication_rbac.P6AuthenticationRbacTests.test_concurrent_http_enrollment_replay_converges_rebound_and_restart": "p6_concurrent_http_replay_convergence_rebound_restart",
    "tests.p6.test_authentication_rbac.P6AuthenticationRbacTests.test_business_commit_without_generic_response_cache_retries_once": "p6_business_commit_response_cache_crash_window",
    ...
    "tests.p6.test_change_approval.P6ChangeApprovalTests.test_cached_admin_replays_require_current_authority_after_formal_downgrade": "p6_cached_replay_formal_privilege_downgrade",
    "tests.p6.test_change_approval.P6ChangeApprovalTests.test_cached_colleague_replay_fails_after_scope_change_and_revocation": "p6_cached_replay_scope_change_revocation",
    "tests.p6.test_change_approval.P6ChangeApprovalTests.test_concurrent_http_governance_mutations_converge_and_survive_restart": "p6_concurrent_governance_replay_restart",
