...
def check_backup_restore(root: Path) -> dict[str, object]:
    ...
    return {
        ...
        "first_release_source": "accepted_p7_git_object_0.0.0_without_release_manifest",
        "first_release_target": "p8_candidate_0.1.0",
        "cross_version_rollback_binding": "p7_backup_source_and_p8_replaced_source",
